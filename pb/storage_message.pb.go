...
type Storage struct {
	...
	Dirver Storage_Driver `protobuf:"varint,1,opt,name=dirver,proto3,enum=Storage_Driver" json:"dirver,omitempty"`
...
func (x *Storage) GetDirver() Storage_Driver {
	if x != nil {
		return x.Dirver
	}
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x07, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x27, 0x0a, 0x06, 0x64, 0x69, 0x72, 0x76,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x2e, 0x44, 0x72, 0x69, 0x76, 0x65, 0x72, 0x52, 0x06, 0x64, 0x69, 0x72, 0x76, 0x65,
...
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: Storage.dirver:type_name -> Storage.Driver
